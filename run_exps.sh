...
nohup bash run_device.sh '' mlc cal500 'base' 32 &> mlc1.out &
BACK_PID=$!
wait $BACK_PID
...
################################3
#  score nodistil task self training
...
# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'nodistil' '' 'nodistil' '' '0.1' 32 32 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'nodistil' '' 'hard_label' '' '0.1' 32 32 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID


# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'nodistil' '' 'label_smoothing' '0.1' '0.1' 32 32 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'nodistil' '' 'label_smoothing' '0.9' '0.1' 32 32 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID

# ###############################
# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'hard_label' '' 'nodistil' '' '0.1' 32 32 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'hard_label' '' 'hard_label' '' '0.1' 32 32 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID


# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'hard_label' '' 'label_smoothing' '0.1' '0.1' 32 32 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'hard_label' '' 'label_smoothing' '0.9' '0.1' 32 32 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID

# ################################3
#  score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'soft_label' '' 'nodistil' '' '0.1' 32 32 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'soft_label' '' 'hard_label' '' '0.1' 32 32 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'soft_label' '' 'label_smoothing' '0.1' '0.1' 32 32 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'soft_label' '' 'label_smoothing' '0.9' '0.1' 32 32 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID

# ################################
# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.1' 'nodistil' '' '0.1' 32 32 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.1' 'hard_label' '' '0.1' 32 32 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID


# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.1' 'label_smoothing' '0.1' '0.1' 32 32 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.1' 'label_smoothing' '0.9' '0.1' 32 32 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID

# ################################3
# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.9' 'nodistil' '' '0.1' 32 32 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.9' 'hard_label' '' '0.1' 32 32 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID


# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.9' 'label_smoothing' '0.1' '0.1' 32 32 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.9' 'label_smoothing' '0.9' '0.1' 32 32 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID
...
# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'nodistil' '' 'nodistil' '' '0.1' 32 64 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'nodistil' '' 'hard_label' '' '0.1' 32 64 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID


# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'nodistil' '' 'label_smoothing' '0.1' '0.1' 32 64 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'nodistil' '' 'label_smoothing' '0.9' '0.1' 32 64 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID

# ###############################
# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'hard_label' '' 'nodistil' '' '0.1' 32 64 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'hard_label' '' 'hard_label' '' '0.1' 32 64 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'hard_label' '' 'label_smoothing' '0.1' '0.1' 32 64 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'hard_label' '' 'label_smoothing' '0.9' '0.1' 32 64 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID

# ################################3
#  score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'soft_label' '' 'nodistil' '' '0.1' 32 64 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'soft_label' '' 'hard_label' '' '0.1' 32 64 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'soft_label' '' 'label_smoothing' '0.1' '0.1' 32 64 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'soft_label' '' 'label_smoothing' '0.9' '0.1' 32 64 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID

# ################################3
# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.1' 'nodistil' '' '0.1' 32 64 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.1' 'hard_label' '' '0.1' 32 64 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.1' 'label_smoothing' '0.1' '0.1' 32 64 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.1' 'label_smoothing' '0.9' '0.1' 32 64 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID

# ################################3
# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.9' 'nodistil' '' '0.1' 32 64 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.9' 'hard_label' '' '0.1' 32 64 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.9' 'label_smoothing' '0.1' '0.1' 32 64 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.9' 'label_smoothing' '0.9' '0.1' 32 64 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID
...
# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'nodistil' '' 'nodistil' '' '0.1' 32 128 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'nodistil' '' 'hard_label' '' '0.1' 32 128 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'nodistil' '' 'label_smoothing' '0.1' '0.1' 32 128 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'nodistil' '' 'label_smoothing' '0.9' '0.1' 32 128 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID
...
# ###############################
# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'hard_label' '' 'nodistil' '' '0.1' 32 128 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'hard_label' '' 'hard_label' '' '0.1' 32 128 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID


# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'hard_label' '' 'label_smoothing' '0.1' '0.1' 32 128 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'hard_label' '' 'label_smoothing' '0.9' '0.1' 32 128 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID
...
# ################################3
#  score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'soft_label' '' 'nodistil' '' '0.1' 32 128 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'soft_label' '' 'hard_label' '' '0.1' 32 128 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'soft_label' '' 'label_smoothing' '0.1' '0.1' 32 128 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'soft_label' '' 'label_smoothing' '0.9' '0.1' 32 128 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID
...
# ################################3
# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.1' 'nodistil' '' '0.1' 32 128 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.1' 'hard_label' '' '0.1' 32 128 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID


# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.1' 'label_smoothing' '0.1' '0.1' 32 128 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.1' 'label_smoothing' '0.9' '0.1' 32 128 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID
...
# ################################3
# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.9' 'nodistil' '' '0.1' 32 128 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score nodistil task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.9' 'hard_label' '' '0.1' 32 128 &> mlc1.out &
# BACK_PID=$!
# wait $BACK_PID

# # score soft_label task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.9' 'label_smoothing' '0.1' '0.1' 32 128 &> mlc3.out &
# BACK_PID=$!
# wait $BACK_PID

# # score ls_0.1 task self training
# nohup bash run_device.sh '' mlc deli 'label_smoothing' '0.9' 'label_smoothing' '0.9' '0.1' 32 128 &> mlc4.out &
# BACK_PID=$!
# wait $BACK_PID
