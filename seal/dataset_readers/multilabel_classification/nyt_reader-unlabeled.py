...
@DatasetReader.register("nyt-mlc-unlabeled")
class NytReaderMLCUnlabeled(BlurbGenreReader):
    """
    ...
    def example_to_fields(
        ...
        **kwargs: Any,
        ...
        import torch
        labels = MetadataField(torch.tensor([-100]))
